...
class OverlaySettings {
  ...
  void password(final BuildContext context) {
    showDialog(
  ...
  void languages(final BuildContext context) {
    showDialog(
      useRootNavigator: false,
      context: context,
      builder: (final BuildContext context) => AlertDialog(
...
// If item is 3, return a container with a list of radio buttons to select a theme
  ...
  void features(final BuildContext context) {
    showDialog(
      useRootNavigator: false,
      context: context,
      builder: (final BuildContext context) => AlertDialog(
        ...
        content: Container(
          ...
          child: ListView(padding: const EdgeInsets.all(8), children: const [
            ...
            SizedBox(height: 8),
            Text("Security - Make server less trusting and check things more"),
            SizedBox(height: 8),
            Text(
...
class LanguagePopupItem extends StatefulWidget {
  const LanguagePopupItem(
      {required this.name, required this.altName, super.key});
  final String name;
      ...
      child: TextButton(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                widget.altName,
                style: TextStyle(fontWeight: FontWeight.w700, color: swatch[0]),
              )
            ],
          )));
}
...
class MainColour extends WidgetStateColor {
  ...
  @override
  Color resolve(final Set<WidgetState> states) => swatch[301]!;
}
